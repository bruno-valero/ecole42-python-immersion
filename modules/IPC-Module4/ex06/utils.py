...
class DuplicatedAccount(Exception):
    def __init__(self, message: str = ""):
        super().__init__(f"This account already exists!!" if not message else message)


class AccountNotFount(Exception):
    def __init__(self, message: str = ""):
        super().__init__(f"Account not found!!" if not message else message)


class InvalidInput(Exception):
    def __init__(self, message: str = ""):
        super().__init__(f"Invalid input!!" if not message else message)
